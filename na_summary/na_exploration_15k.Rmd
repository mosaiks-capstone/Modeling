...
```{r}
df_15k <- read_feather("~/cropmosaiks/NA_exploration/shared_folder/15k_data.feather")
```
...
na_count_names %>% 
  ...
  #scale_fill_continuous(type = "gradient", breaks = c(0, 5000, 10000, 15000, 20000)) +
  #scale_fill_continuous(type = "gradient", breaks = c(0, 5000, 10000, 15000, 20000)) +
  #scale_fill_viridis_b(breaks = c(0, 5000, 10000, 15000, 20000)) +
  #scale_fill_gradient2('pi0', low = "white", mid = "blue", high = "red", midpoint = 0) +
  #guides(fill = guide_legend(title = "Raw Quantity of\nFeatures that are NA", reverse = TRUE)) +
